...
export default function VendorEditBundle() {
  ...
  useEffect(() => {
    const loadBundle = async () => {
      try {
        const { data } = await API.get(`/vendor/bundles/${id}`);
        ...
        toast.error("Could not load bundle details");
  ...
  const handleSubmit = async () => {
    if (!title || !price || !category || images.length === 0 || items.length === 0) {
    ...
    try {
      ...
      await API.put(`/vendor/bundles/${id}`, payload);
    ...
    return (
      <div className="flex min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="flex-1">
          <VendorTopbar title="Edit Bundle" />
      ...
      <div className="flex-1">
        ...
        <main className="p-4 lg:p-6 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Edit Bundle</h2>
              <p className="text-gray-600 mt-1">Update your bundle details and configuration</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{bundleStats.sold}</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">₹{bundleStats.revenue.toLocaleString()}</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{bundleStats.views.toLocaleString()}</p>
                </div>
          ...
          {/* View Mode Toggle */}
          <div className="flex bg-white border border-gray-200 rounded-lg p-1 mb-6 w-fit">
            <button
              onClick={() => setViewMode("form")}
              className={`px-4 py-2 rounded-md flex items-center gap-2 transition-colors ${viewMode === "form"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <AnimatePresence>
                  {items.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 mb-2">No items added</p>
                      <p className="text-sm text-gray-500">Add products to your bundle</p>
                    </div>
                  ) : (
              ...
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6"
              >
                <h3 className="text-xl font-bold text-gray-900 mb-6">Bundle Status</h3>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-gray-900">Bundle Visibility</p>
                    <p className="text-sm text-gray-500">
                      {isActive ? "Bundle is visible to customers" : "Bundle is hidden from customers"}
                    </p>
                  </div>
                  <button
            ...
            <div>
              ...
              >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-semibold ${isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'
                          }`}>
                          {isActive ? 'Active' : 'Inactive'}
                        </span>
                      </div>
                ...
                <button
                  ...
                  disabled={saving || !title || !price || !category || images.length === 0 || items.length === 0}
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="text-center p-2 bg-blue-50 rounded-lg">
                      <div className="text-sm font-bold text-gray-900">{items.length}</div>
                      <div className="text-xs text-gray-500">Items</div>
                    </div>
                    <div className="text-center p-2 bg-green-50 rounded-lg">
                      <div className="text-sm font-bold text-gray-900">{images.length}</div>
              ...
              <div className="mt-6 space-y-3">
                <Link
                  to={`/bundles/${id}`}
                  target="_blank"
                  className="block w-full px-4 py-3 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors text-center font-medium"
                >
                  View Live Page
                </Link>
                <button
